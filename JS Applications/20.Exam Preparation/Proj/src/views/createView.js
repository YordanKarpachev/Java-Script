...
const template = (onCreate, onClick) => html`        <section class="createPage">
<form @submit=${onCreate}>
    <fieldset>
        ...
        <div class="container">
            ...
            <button @click=${onClick} class="add-album" type="submit">Add New Album</button>
        </div>
    </fieldset>
</form>
</section>`;
...
export const createView = (ctx, next) => {
    ...
    ctx.render(template(onCreate, onClick))
